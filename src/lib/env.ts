...
const envSchema = z.object({
  ...
  AUTH_SECRET: z.string().default('canvas-productivity-secret-key-development-32-chars-long!'),
...
export const env = envSchema.parse({
  ...
  AUTH_SECRET: process.env.AUTH_SECRET || 'canvas-productivity-secret-key-development-32-chars-long!',
