...
export const INITIAL_SOUNDS: SoundTrack[] = [
  { id: 'sound-1', name: 'Gentle Rain', category: 'Nature', volume: 65, isPlaying: true, type: 'rain' },
  { id: 'sound-2', name: 'Cozy Fireplace', category: 'Ambient', volume: 40, isPlaying: true, type: 'fireplace' },
